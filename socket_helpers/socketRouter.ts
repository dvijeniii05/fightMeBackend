...
import { activeFightRoomsRoute } from "./message_routes/activeFightRoomsRoute";
...
export const messageRouter = async (
  ...
  switch (type) {
    ...
    case "submitAttack":
      return submitAttackRoute(server, ws, rest);
    case "submitBlock":
      return await submitBlockRoute(server, ws, rest);
    case "activeHeroes":
